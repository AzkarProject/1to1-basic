...
function mainSettings() {
    ...
    // >>> DDNS / Azcary(Filaire-I3S) <> Thaby(Eduroam) / sparks.tcp >>> ???
    // >>> DDNS / Azcary(Filaire-I3S) <> Thaby(Eduroam) / sparks.udp >>> ???
    // >>> DDNS / Azcary(Filaire-I3S) <> Thaby(Unice) / all turns >>>
    // >>> DDNS / Azcary(Filaire-I3S) <> Thaby(Unice) / sparks.tcp >>> ??? 
    // >>> DDNS / Azcary(Filaire-I3S) <> Thaby(Unice) / sparks.udp >>> ??
